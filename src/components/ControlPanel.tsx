    ...
    <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
      ...
      <div className="bg-gray-800 px-4 py-3 border-b border-gray-700">
        <div className="flex items-center gap-2">
          <span className="text-xs font-bold bg-purple-700 px-2 py-1 rounded text-white">CONTROL</span>
          <h2 className="text-lg font-semibold text-white">Trading Mode & Account</h2>
        </div>
      </div>
      ...
      <div className="p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-800/50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-3">Trading Mode</h3>
            ...
            <div className="text-xs space-y-1">
              <div className="flex justify-between">
                ...
                <span className={`font-bold ${currentMode === 'REAL' ? 'text-green-400' : 'text-yellow-400'}`}>
                  {currentMode}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Bridge Mode:</span>
                <span className={`font-bold ${
                  bridgeMode === 'REAL' ? 'text-green-400' : 
                  bridgeMode === 'DEMO' ? 'text-yellow-400' : 'text-gray-400'
                }`}>
                  {bridgeMode}
                </span>
              </div>
            ...
            {!modeMatches && isConnected && (
              <div className="mt-3 p-2 bg-orange-900/30 border border-orange-700 rounded-lg">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="mt-2 w-full py-1.5 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-600 text-white text-xs font-bold rounded transition-colors"
                >
                  Restart Bridge
                </button>
              </div>
          ...
          {/* Account Info */}
          <div className="bg-gray-800/50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-3">Account Status</h3>
            ...
            {accountInfo && (
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-mono truncate max-w-[150px]" title={accountInfo.server || '-'}>
                    {accountInfo.server || '-'}
                  </span>
                </div>
            ...
            <button
              ...
              className="mt-3 w-full py-1.5 bg-gray-700 hover:bg-gray-600 text-gray-300 text-xs rounded transition-colors"
            >
              Refresh
            </button>
          </div>
